      ...
      <div className="mt-8 sm:mt-10 lg:mt-[120px]">
        <div className="relative">
          <div className="pr-7 mb-4 sm:mb-6 lg:mb-8 space-y-3">
            <h2 className="text-[16px] sm:text-[20px] lg:text-[28px] font-semibold text-[#1B1743] cursor-pointer">
          ...
          <div className="absolute right-[2px] top-[7px]">
            <IoIosArrowUp className="text-2xl sm:text-[32px] text-[#AAB6B5]" />
          </div>
        </div>
        <div className="relative">
          ...
          <div className="h-[1px] bg-[#D4DBE0]"></div>
          <div className="absolute right-[2px] top-[7px]">
            <IoIosArrowDown className="text-2xl sm:text-[32px] text-[#AAB6B5]" />
          </div>
        </div>
        <div className="relative">
          <div className="pr-7 my-4 sm:my-6 lg:my-8">
